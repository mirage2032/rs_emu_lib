...
impl XOR_PIXD {
    pub fn new(memory: &dyn MemoryDevice, pos: u16) -> Result<XOR_PIXD, MemoryReadError> {
        Ok(XOR_PIXD {
    ...
    pub fn new_with_value(d: u8) -> XOR_PIXD {
        XOR_PIXD {
            common: InstructionCommon::new(3, 19, true),
            d: d as i8,
        }
...
impl BaseInstruction for XOR_PIXD {
    fn common(&self) -> &InstructionCommon {
        &self.common
    }
    fn to_bytes(&self) -> Vec<u8> {
        vec![0xdd, 0xae, self.d as u8]
    }
}

impl ExecutableInstruction<Z80> for XOR_PIXD {
...
mod tests {
    ...
    test_z80!("dd ae");
    test_instruction_parse!(XOR_PIXD, [0x53]);
}
