...
impl RRC_PIYD {
    pub fn new(memory: &dyn MemoryDevice, pos: u16) -> Result<RRC_PIYD, MemoryReadError> {
        Ok(RRC_PIYD {
    ...
    pub fn new_with_value(d: u8) -> RRC_PIYD {
        RRC_PIYD {
            common: InstructionCommon::new(4, 23, true),
            d: d as i8,
        }
...
impl BaseInstruction for RRC_PIYD {
    fn common(&self) -> &InstructionCommon {
        &self.common
    }
    fn to_bytes(&self) -> Vec<u8> {
        vec![0xfd, 0xcb, self.d as u8, 0x0e]
    }
}

impl ExecutableInstruction<Z80> for RRC_PIYD {
